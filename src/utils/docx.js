...
function buildDoc(form) {
  ...
  if (isYavi) {
    ...
    children.push(tcPara('3', 'Term', 'The Service Period and all applicable Renewal Tenures are collectively referred to as the \u201cOrder Form Term\u201d. This Order Form is effective on the date the Service Period commences. Renewal will be applicable on then-current list price. a. Non-Renewal Notice \u2014 Where auto-renewal is applicable, if the Client does not wish to renew, the Client shall provide written notice of non-renewal at least thirty (30) days prior to the Order Form End Date, failing which the Order Form shall automatically renew.'));
    ...
    children.push(tcPara('2', 'Term', 'The Order Form Term includes the initial Service Period and all subsequent Renewal Terms. The Order Form becomes effective on the commencement date of the Service Period. Renewal shall be subject to the then-current list price prevailing at the time of renewal. a. Non-Renewal Notice \u2014 Where auto-renewal is applicable, if the Client does not wish to renew, the Client shall provide Fynd written notice of non-renewal at least thirty (30) days prior to the Order Form End Date, failing which the Order Form shall automatically renew.'));
