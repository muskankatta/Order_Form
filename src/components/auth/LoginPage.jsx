...
export default function LoginPage() {
  ...
  const [noAccessEmail, setNoAccessEmail] = useState(null); // non-null → show NoAccess screen
  ...
  // Non-gofynd / unlisted fynd.team user
  if (noAccessEmail) {
    return <NoAccess email={noAccessEmail} onBack={() => setNoAccessEmail(null)} />;
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center"
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8">
        ...
        {/* Logo */}
        <div className="mb-8">
          <img src={`${import.meta.env.BASE_URL}Fynd_Horizontal_Dark.svg`} alt="Fynd" className="h-10 mb-2" />
