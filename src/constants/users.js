export const SALES_REPS = [
  ...
  // ── GLOBAL TEAM ────────────────────────────────────────────────────────────
  { id:'S105', name:'Dharmendra Mehta',  slack:'U07KGJ8MTUK', email:'dharmendra@gofynd.com',        team:'Global', role:'Sales',          target:800000,    targetCurrency:'USD' },
  { id:'2532', name:'Evani Routray',     slack:'U05SCN10HJ4', email:'evaniroutray@gofynd.com',      team:'Global', role:'Sales',          target:350000,    targetCurrency:'USD' },
  { id:'3125', name:'Harsh Kumar',       slack:'U09Q11L8E6Q', email:'harshkumar@gofynd.com',        team:'Global', role:'Sales',          target:305000,    targetCurrency:'USD' },
  { id:'3010', name:'Komal Karani',      slack:'U092K3NU18S', email:'komalkarani@gofynd.com',       team:'Global', role:'Designer',          target:null,      targetCurrency:'USD' },
  { id:'1327', name:'Nayan Lathiya',     slack:'U018REY8UA2', email:'nayanlathiya@gofynd.com',      team:'Global', role:'Product',          target:85000,     targetCurrency:'USD' },
  { id:'S106', name:'Novriansyah',       slack:'U07KA2RMW0N', email:'novri@fynd.team',              team:'Global', role:'Sales',          target:500000,    targetCurrency:'USD' },
  { id:'1028', name:'Ronak Modi',        slack:'U0BDD4119',   email:'ronakmodi@gofynd.com',         team:'Global', role:'CBO',          target:650000,    targetCurrency:'USD' },
  { id:'S112', name:'Rushabh Mehta',     slack:'U08F74BT57E', email:'rushabhmehta1@gofynd.com',     team:'Global', role:'Sales',          target:600000,    targetCurrency:'USD' },
  { id:'3059', name:'Vipul Aggarwal',    slack:'U099PMC6FNV', email:'vipulaggarwal@gofynd.com',     team:'Global', role:'Sales',          target:350000,    targetCurrency:'USD' },
  { id:'S111', name:'Vishesh Kumar',     slack:'UFJ0SDTLH',   email:'visheshkumar@gofynd.com',      team:'Global', role:'Sales',          target:550000,    targetCurrency:'USD' },
  { id:'2271', name:'Yazdan Irani',      slack:'U048V9AHNA3', email:'yazdanirani@gofynd.com',       team:'Global', role:'Sales',          target:400000,    targetCurrency:'USD' },
  { id:'3080', name:'Shubham Soni',      slack:'U09D0KUAG76', email:'shubhamsoni@gofynd.com',       team:'Global', role:'-',            target:100000,    targetCurrency:'USD' },
